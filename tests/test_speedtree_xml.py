...
class SafetyTests(unittest.TestCase):
    ...
    def test_target_orchestration_passes_delivery_intent_to_producer(self):
        with tempfile.TemporaryDirectory() as folder:
            ...
            original_export = speedtree.export_or_update_speedtree_spm_path
            ...
            speedtree.export_or_update_speedtree_spm_path = fake_export
            try:
                ...
                speedtree.export_or_update_speedtree_spm_path = original_export
